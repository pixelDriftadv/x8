...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between py-24 px-8">
      ...
      />
      {/* <ReactPlayer
        url="/5july/5july3.webp"
        controls={true}
        width="80vw" // Show native player controls
      /> */}
      <img src="/5july/5july3.webp" alt="" className=" h-auto w-[40vw]" />
      <br /> <br />
      ...
      <p className="z-10 flex flex-col items-center justify-center space-x-2 whitespace-pre-wrap text-center text-xl font-bold tracking-tighter ">
        ...
        You dont know it mate, your silence, offline for just a few days scares
        me interally, diseases and accidents are now vey common, I pray to god
        that me, you, our families are healthy always
      </p>
    </main>
  );
}
